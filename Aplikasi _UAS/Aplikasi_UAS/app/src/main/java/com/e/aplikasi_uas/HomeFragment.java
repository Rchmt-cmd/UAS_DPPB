...
public class HomeFragment extends Fragment {
    ...
    private Button mOpenButtonShare, mMapButton, mShareTextButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mOpenButtonShare = view.findViewById(R.id.open_website_button);
        mMapButton = view.findViewById(R.id.map_button);
        mShareTextButton = view.findViewById(R.id.share_text_button);
        ...
        mOpenButtonShare.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
